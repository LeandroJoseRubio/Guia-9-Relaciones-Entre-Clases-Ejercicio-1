...
public class Revolver {
    ...
    private Integer posicionActual; // entre 1 y 6
    private Integer posicionAgua; // entre 1 y 6
    ...
    public void setPosiciónActual(Integer posicionActual) {
        this.posicionActual = posicionActual;
    }

    public void setPosiciónAgua(Integer posicionAgua) {
        this.posicionAgua = posicionAgua;
    }
